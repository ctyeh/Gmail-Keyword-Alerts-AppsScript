/**
 * core/slack.js - Slack API 核心功能模組
 * 
 * 此檔案包含所有與 Slack 相關的核心功能，包括:
 * - 發送郵件通知到 Slack
 * - 發送統計報告到 Slack
 * - 發送錯誤通知
 * 
 * 作為核心 API 模組，負責與 Slack 服務的所有交互
 * 
 * 依賴模組:
 * - env.js (ENABLE_SLACK_NOTIFICATIONS, SLACK_WEBHOOK_URL)
 * - utils.js (formatDateTime, truncateString)
 */
