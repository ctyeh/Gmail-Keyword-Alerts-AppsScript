/**
 * gmail.js - Gmail 郵件操作相關函數
 * 
 * 此檔案包含所有與 Gmail 郵件操作相關的函數，包括:
 * - 搜尋查詢建立
 * - 標籤處理
 * - 郵件內容分析
 * - 關鍵字檢查
 * 
 * 依賴模組:
 * - env.js (CHECKED_LABEL, NOTIFIED_LABEL, EXCLUDED_DOMAINS, SINGLE_KEYWORDS, KEYWORD_COMBINATIONS)
 * - utils.js (extractDomainFromSender)
 */
